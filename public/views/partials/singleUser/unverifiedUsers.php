<div ng-controller='singleUserController' ng-init='getData()'>
        <div class="upper" style="background-image :url('{{singleUser.user_name.dpUrl}}'); background-size: cover; background-position: center center; background-color: rgba(0,0,0,.3)">
            ...
            <div class="col-md-4 pull-left">
                <button class='btn btn-danger' style='float: right; margin-right: 10px;' data-toggle='modal' data-target='#modal-unverify' ng-click='button= "unverify"'>Unverify</button>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4 pull-right">
                ...
                <button class='btn btn-success' ng-click="verify()"  ng-model='button' value='verify'>VERIFY</button>
            </div>
        </div>
